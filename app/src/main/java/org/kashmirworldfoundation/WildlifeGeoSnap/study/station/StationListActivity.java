...
import org.kashmirworldfoundation.WildlifeGeoSnap.study.station.tasks.StationAsyncTaskA;
...
public class StationListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private StationListAdapter listFragmentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ///listFragmentAdapter=new StudyListFragmentAdapter(CStationArrayList,this);
    ...
    public void onClick(View v) {
        ...
        Intent i= new Intent(getApplication().getApplicationContext(), StationActivity.class);
    ...
    public void updateList(){
        listFragmentAdapter=new StationListAdapter(CStationArrayList,this);
        recyclerView.setAdapter(listFragmentAdapter);
